...
public enum ResultEnum {
  ...
  PARAM_EXCEPTION("3002", "参数异常"),
  DATABASE_EXCEPTION("3003", "数据库异常"),
  UN_KNOW_ERROR("3004", "未知后台错误"),
  SYSTEM_ERROR("3005", "系统错误"),
  BASE_EXCEPTION("3006", "自定义异常"),
  REQUEST_NOT_SUPPORTED_EXCEPTION("3007", "前端请求方式与后端接收方式不匹配"),
  NO_RESOURCE_FOUND_EXCEPTION("3008", "请求路径不存在"),
  FAIL("3400", "操作失败");
